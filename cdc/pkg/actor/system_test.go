...
// Run the benchmark
// go test -benchmem -run='^$' -bench '^(BenchmarkActorSendReceive)$' github.com/tikv/migration/cdc/pkg/actor
...
// Run the benchmark
// go test -benchmem -run='^$' -bench '^(BenchmarkPollActor)$' github.com/tikv/migration/cdc/pkg/actor
