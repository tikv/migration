...
func (s *stateSuite) TestChangefeedStateUpdate(c *check.C) {
	...
	testCases := []struct {
		...
		{ // common case
			...
			updateValue: []string{
				`{"sink-uri":"blackhole://","opts":{},"create-time":"2020-02-02T00:00:00.000000+00:00","start-ts":421980685886554116,"target-ts":0,"admin-job-type":0,"sort-engine":"memory","sort-dir":"","config":{"enable-old-value":false,"check-gc-safe-point":true,"sink":{"dispatchers":null,"protocol":"open-protocol"},"scheduler":{"type":"keyspan-number","polling-time":-1},"consistent":{"level":"normal","storage":"local"}},"state":"normal","history":null,"error":null,"sync-point-enabled":false,"sync-point-interval":600000000000}`,
