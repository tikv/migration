...
func (z *RawKVEntry) EncodeMsg(en *msgp.Writer) (err error) {
	...
	// write "expired_ts"
	err = en.Append(0xaa, 0x65, 0x78, 0x70, 0x69, 0x72, 0x65, 0x64, 0x5f, 0x74, 0x73)
	if err != nil {
		return
	}
...
func (z *RawKVEntry) MarshalMsg(b []byte) (o []byte, err error) {
	...
	// string "expired_ts"
	o = append(o, 0xaa, 0x65, 0x78, 0x70, 0x69, 0x72, 0x65, 0x64, 0x5f, 0x74, 0x73)
...
func (z *RawKVEntry) Msgsize() (s int) {
	s = 1 + 8 + msgp.IntSize + 4 + msgp.BytesPrefixSize + len(z.Key) + 6 + msgp.BytesPrefixSize + len(z.Value) + 10 + msgp.BytesPrefixSize + len(z.OldValue) + 9 + msgp.Uint64Size + 5 + msgp.Uint64Size + 11 + msgp.Uint64Size + 10 + msgp.Uint64Size + 11 + msgp.Uint64Size + 9 + msgp.Uint64Size
	return
}
