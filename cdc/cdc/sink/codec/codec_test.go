...
var (
	codecEntryCases = [][]*model.RawKVEntry{{{
		...
		Value:  []byte("0000000000000000003"),
...
// 		converted.Ts = append(converted.Ts, event.CRTs)
...
func init() {
	var err error
	// if codecCraftEncodedRowChanges, err = codecEncodeKvCase(NewCraftEventBatchEncoder(), codecBenchmarkRowChanges); err != nil {
	// 	panic(err)
	// }
...
// 	for i := 0; i < b.N; i++ {
// 		_, _ = codecEncodeKvCase(NewCraftEventBatchEncoderWithAllocator(allocator), codecBenchmarkKvChanges)
// 	}
// }
...
// 	for i := 0; i < b.N; i++ {
// 		_ = codecEncodeRowChangedPB1ToMessage(codecBenchmarkKvChanges)
// 	}
// }

// func BenchmarkProtobuf2Encoding(b *testing.B) {
// 	for i := 0; i < b.N; i++ {
// 		_ = codecEncodeRowChangedPB2ToMessage(codecBenchmarkKvChanges)
// 	}
// }
