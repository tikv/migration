...
// Source: github.com/tikv/migration/br/pkg/storage (interfaces: ExternalStorage)

// $ mockgen -package mockstorage github.com/tikv/migration/br/pkg/storage ExternalStorage > pkg/mock/storage/storage.go
...
import (
	...
	storage "github.com/tikv/migration/br/pkg/storage"
)
...
func (mr *MockExternalStorageMockRecorder) DeleteFile(ctx, name interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
