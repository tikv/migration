...
GO_FAILPOINTS="github.com/tikv/migration/br/pkg/restore/not-leader-error=1*return(true)->1*return(false);\
github.com/tikv/migration/br/pkg/restore/somewhat-retryable-error=3*return(true)" \
