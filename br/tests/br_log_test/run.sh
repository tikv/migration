...
export GO_FAILPOINTS="github.com/tikv/migration/br/pkg/backup/tikv-rw-error=return(\"Io(Os { code: 13, kind: PermissionDenied...})\")"
...
export GO_FAILPOINTS="github.com/tikv/migration/br/pkg/backup/tikv-rw-error=return(\"Io(Os { code: 2, kind:NotFound...})\")"
