...
export GO_FAILPOINTS="github.com/tikv/migration/br/pkg/backup/reset-retryable-error=1*return(true)"
...
export GO_FAILPOINTS="github.com/tikv/migration/br/pkg/backup/reset-not-retryable-error=1*return(true)"
...
export GO_FAILPOINTS="github.com/tikv/migration/br/pkg/backup/backup-storage-error=1*return(\"connection refused\")"
...
for ct in limit lz4 zstd; do
  ...
  export GO_FAILPOINTS="github.com/tikv/migration/br/pkg/restore/restore-storage-error=1*return(\"connection refused\");github.com/tikv/migration/br/pkg/restore/restore-gRPC-error=1*return(true)"
